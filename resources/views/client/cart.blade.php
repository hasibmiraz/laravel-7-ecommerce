	    				...
	    				<table class="table">
							...
							@if (Session::has('cart'))
								...
								@foreach ($products as $product)
									<tr class="text-center">
									<td class="product-remove"><a href="{{ route('remove.item', ['id' => $product['product_id']]) }}"><span class="ion-ios-close"></span></a></td>
									...
									{!! Form::open(['route' => ['update.qty', 'id' => $product['product_id']], 'method' => 'POST']) !!}
										@csrf
										<td class="quantity">
